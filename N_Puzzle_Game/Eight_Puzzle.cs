...
namespace N_Puzzle_Game
{
    public partial class Eight_Puzzle : Form
    {
        string path = "";
        Timer t;
        UserControl_Eigth_Puzzle_Numbers usdg;
        UserControl_Eigth_Puzzle_Pictures uspc;
        public bool b_bfs = false, b_gbfs = false, b_a_star = false;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked)
            {
                ...
                bfs.solution.Clear();
                usdg = new UserControl_Eigth_Puzzle_Numbers(270);
                panel1.Controls.Add(usdg);
            }
            else if (radioButton2.Checked && path != "")
            {
                panel1.Controls.Clear();
                uspc = new UserControl_Eigth_Puzzle_Pictures(path, 270);
